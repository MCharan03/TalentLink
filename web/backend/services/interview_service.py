...
import json
from backend.models import UserData, MockInterview, db
from backend.utils.ai_utils import get_interview_question, generate_interview_report, _call_ai
...
class InterviewService:
    ...
    def get_next_question(self, last_answer, stage="continue", context=None,
        ...
        """Generates the next interview question with adaptive difficulty, type, and agent awareness."""
