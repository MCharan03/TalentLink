...
def get_interview_question(answer, stage="continue", resume_context=None,
                            interview_type="mixed", difficulty="medium", agent="aura",
                            round_number=1, conversation_history=None):
    """
    Gets the next interview question from the Gemini API.
    Supports adaptive difficulty, interview types, agent personas,
    ...
    if stage == "start":
        ...
        agent_instructions = {
            "aura": "Name: Aura AI. Style: Professional, polite, and polished. You act like a standard corporate HR interviewer. You are balanced, clear, and constructive.",
            "neuro": "Name: Neuro-Scribe. Style: Clinical, data-driven, and slightly strict. You prefer concise answers and focus heavily on logic, structure, and hard facts. You lack warmth but are highly objective.",
            "oracle": "Name: The Oracle. Style: Encouraging but deeply probing. You act like an experienced senior leader who wants to understand the candidate's core motivations, cultural fit, and behavioral patterns."
        }
        agent_instruction = agent_instructions.get(agent, agent_instructions["aura"])
        ...
        - Interviewer Persona: {agent_instruction}
        ...
        Task:
        1. EVALUATE: Briefly assess their answer (2-3 sentences), speaking IN CHARACTER as your persona. Was it complete? Technical accuracy? If it's a behavioral answer, evaluate STAR method adherence. If wrong, gently correct them based on your persona's style.
        2. TRANSITION: Provide a smooth transition sentence IN CHARACTER.
        3. NEXT QUESTION: Ask the next question appropriate for the current round, difficulty, and interview type.
        
        Keep your response conversational but strictly adhere to your Persona's style. Never repeat a question from the history.
        """
